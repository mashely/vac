          ...
          <div class="pt-4">
            <div id="sales-status-chart-legend" class="sales-status-chart-legend">
                <ul class="legend2">
                    ...
                    <li><span class="legend-label" style="background-color:#04b76b"></span>18 hadi 24<label class="badge badge-light badge-pill legend-percentage ml-auto">{{18hadi24}}%</label></li>
                    <li><span class="legend-label" style="background-color:#ff5e6d"></span>8 hadi 17<label class="badge badge-light badge-pill legend-percentage ml-auto">{{8hadi17}}%</label></li> 
